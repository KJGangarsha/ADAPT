...
componentDidMount(){
    ...
    ManagerService.getRoomByNumber(this.state.roomNumber).then((res)=>{
        let room = res.data;
        this.setState({
            roomId:room.roomId,
...
checkOutGuest = (e) => {
    ...
    GuestService.createCheckOut(guest);

    GuestService.deleteGuest(this.state.guestId);    
    
    localStorage.removeItem("checkInDate");

    let room = {roomType: this.state.roomType, roomNumber: this.state.roomNumber, roomPrice: this.state.price, roomStatus:"Empty"};
    ManagerService.updateRoom(room, this.state.roomId).then(res =>{
        this.props.history.push('/checkOutView');
    });
}
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3"style={{marginTop:"20px",backgroundColor:"blanchedalmond", fontSize:'15px',borderColor:"black", boxShadow:'2px 5px 30px 2px black', fontFamily:'cursive', borderWidth:"3px"}}>
                                ...
                                <div className = "card-body"style={{marginTop:"10px",marginBottom:"10px",backgroundColor:"white",fontSize:'15px',boxShadow:'2px 5px 30px 2px black',fontFamily:'cursive',color:'b#002147', borderColor:"black", borderWidth:"2px"}}>
                                        ...
                                        <div className = "row">
                                            ...
                                            <select placeholder="Payment Method" name="Payment Method" className="form-control" 
                                        ...
                                        <button className="btn btn-success" onClick={this.checkOutGuest}><b>Check-Out</b></button>
