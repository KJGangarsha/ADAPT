               ...
               <div className = "card col-md-6 offset-md-3"style={{marginTop:"50px",backgroundColor:"blanchedalmond", fontSize:'15px',borderColor:"black", boxShadow:'2px 5px 30px 2px black', fontFamily:'cursive', borderWidth:"3px"}}>
                    ...
                    <div className = "card-body"style={{marginTop:"10px",marginBottom:"0.5px",backgroundColor:"white",fontSize:'15px',boxShadow:'2px 5px 30px 2px black',fontFamily:'cursive',color:'b#002147', borderColor:"black", borderWidth:"2px"}}>
                        <div className = "row">
                            ...
                            <div><i>{ this.state.employee.staffName }</i></div>
                        </div>                    

                        <div className = "row">
                            <label> <b>Employee's Department  :</b> </label><br/>
                            <div><i> { this.state.employee.staffDepartment }</i></div>
                        </div>

                        <div className = "row">
                            <label> <b>Employee Contact  :</b> </label><br/>
                            <div><i> { this.state.employee.staffContact }</i></div>
                        </div>

                        <div className = "row">
                            <label> <b>Employee MailId  :</b> </label><br/>
                            <div><i> { this.state.employee.staffMailId }</i></div>
                        </div>

                        <div className = "row">
                            <label> <b>Employee Gender  :</b> </label><br/>
                            <div><i> { this.state.employee.staffGender }</i></div>
                        </div>
