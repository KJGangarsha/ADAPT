        ...
        {/* Header component */}
          ...
          <div className="container">
            <Switch>
              ...
              <OwnerRoute path="/editManager/:managerId" component={UpdateManager}/>
              <OwnerRoute path = "/viewManager/:managerId" component = {ViewManager}/>
              ...
              <ManagerRoute path="/editInventory/:inventoryId" component={UpdateInventory}/>
              <ManagerRoute path = "/viewInventory/:inventoryId" component = {ViewInventory}/>
              ...
              <StaffRoute path="/addGuest/:roomId/:roomType/:roomPrice" component={AddGuest}/>
              <StaffRoute path="/editGuest/:guestId" component={UpdateGuest}/>
              <StaffRoute path = "/viewGuest/:guestId" component = {ViewGuest}/>                          
              <StaffRoute path="/checkOutGuest/:guestId/:room/:date" component={CheckOutGuest}/>
